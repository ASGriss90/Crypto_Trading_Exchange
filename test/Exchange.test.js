...
contract('Exchange', ([deployer, feeAccount, user1, user2]) => {
  ...
  beforeEach(async () => {
    ...
    console.log('Checking to see if user 2 is recieving tokens:')
    token.transfer(user2, tokens(100), { from: deployer })
  ...
  describe('checking balances', async () => {
    ...
    //NEED TO FIX THE RETURN VALUE. THE EXPECTED VALUE DOES NOT RETURN
   ...
   describe('order action', async () => {
    ...
    describe('cancelling orders', async () => {
            ...
            describe('success', async () => {
                ...
                it('updates cencelled orders', async () => {
                    const orderCanclled = await exchange.orderCancelled(1)
                    orderCanclled.should.equal(true)
                })
